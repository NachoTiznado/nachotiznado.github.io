...
permalink: /teaching/
title: Teaching
description: Teaching experience, reflections, and student perspectives.
nav: true
nav_order: 3
---
...
<div class="teaching-page">
  ...
  <div class="teaching-section-header">
    ...
    <p>Why teaching matters to me</p>
  </div>
  ...
  <div class="teaching-reflection">
    ...
    <p>
      ...
      them. I see teaching not only as the communication of concepts and
      methods, but also as a process of encouraging students to ask meaningful
      questions, think critically, and connect theoretical ideas with
  ...
  <div class="teaching-section-header">
    ...
    <p>Undergraduate and graduate teaching across Canada and Chile.</p>
  </div>
...
.teaching-level-card:nth-child(2) {
  background: color-mix(
    in srgb,
    #6ca56c 10%,
    var(--global-bg-color)
